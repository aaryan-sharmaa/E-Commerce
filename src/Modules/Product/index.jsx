    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto text-start">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img
            alt={product?.title}
            className="lg:w-1/2 w-full lg:h-auto max-h-[55  0px] h-64 object-contain object-center rounded"
            src={product?.image}
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex  justify-between items-center mt-10">
              <span className="title-font font-medium text-2xl text-gray-900 mr-10">
                ${product?.price}
              </span>
              <div className="flex">
